...
![Data Matrix ECC 200](/assets/barcodes/two-dimensional/datamatrix.svg)

[Data Matrix](https://en.wikipedia.org/wiki/Data_Matrix) is a two-dimensional code consisting of black and white "cells" (or dots) arranged in either a square or rectangular pattern, known as a matrix. The information to be encoded can be text or numeric data.

This symbol can encode a large amount of data in a small area.

The implementation of Data Matrix only supports [ECC 200 encoding](https://www.barcodefaq.com/2d/data-matrix/) standard.
...
![Data Matrix ECC 200 (12 x 12)](/assets/barcodes/two-dimensional/datamatrix-12x12.svg)
...
![HIBC Data Matrix](/assets/barcodes/two-dimensional/datamatrix-hibc.svg)
...
![Data Matrix ECC 200 (12 x 64)](/assets/barcodes/two-dimensional/datamatrix-12x64.svg)
