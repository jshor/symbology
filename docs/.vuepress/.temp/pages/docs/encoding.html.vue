...
<tr>
<td><code v-pre>WSCAPE_MODE</code></td>
<td>Process input data for escape sequences.</td>
</tr>
</tbody>
</table>
...
<p>Starting in version 2.1.0, the <code v-pre>Encoding</code> enum has been renamed to <code v-pre>EncodingMode</code>, and <code v-pre>Encoding</code> will be removed in the next major release.</p>
</div>
